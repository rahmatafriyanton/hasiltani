...
! function(e) {
  ...
  t = {
    ...
    whenAll: function(i) {
      ...
      for (n = o = s = Array(f), l = function(e, t, i) {
        ...
        }, a = 0; f > a; a++)(r = c[a]) && e.isFunction(r.promise) ? r.promise().done(l(a, s, c)).fail(l(a, n, o)) : (u.notifyWith(this, r), --g);
        ...
        i = a.resumableManager = {
          ...
          sendAjax: function(e, s, l) {
            ...
            if (!i.chunksProcessed[u] || !i.chunksProcessed[u][e]) {
              if (s > r.maxRetries) return v(g.resumableMaxRetriesReached, {
                n: r.maxRetries
              ...
              h = new FormData, d = o.stack[u], a._setUploadData(h, {
                ...
                w = a._getOutData(h, r), a.showPreview && (f.hasClass("file-preview-success") || (a._setThumbStatus(f, "Loading"), t.addCss(f, "file-uploading")), m.attr("disabled", !0)), a._raise("filechunkbeforesend", [u, e, s, o, i, w])
              }, _ = function(t, d, c) {
                ...
                t.error ? (r.showErrorLog && a._log(n.retryStatus, {
                  ...
                  filename: i.fileName,
                  chunk: e
                }), a._raise("filechunkerror", m), i.pushAjax(e, s + 1), i.error = t.error, v(t.error)) : (i.logs[t[f]] = !0, i.chunksProcessed[u] || (i.chunksProcessed[u] = {}), i.chunksProcessed[u][t[f]] = !0, i.chunksProcessed[u].data = t, l.resolve.call(null, t), a._raise("filechunksuccess", m), i.check())
              }, C = function(t, r, n) {
                return a._isAborted() ? void v(g.resumableAborting) : (w = a._getOutData(h, t), i.setAjaxError(t, r, n), a._raise("filechunkajaxerror", [u, e, s, o, i, w]), i.pushAjax(e, s + 1), void v(g.resumableRetryError, {
                  n: s - 1
                }))
              }, x = function() {
    ...
    _initTemplateDefaults: function() {
      var i, a, r, n, o, s, l, d, c, u, p, f, g, m, v, h, w, b, _, C, x, y, T, P, F, k, S, E, I, A, D, z, $, j, U, M, R, O, B, L, N, Z, H = this,
        W = function(e, i) {
      ...
      i = '{preview}\n<div class="kv-upload-progress kv-hidden"></div><div class="clearfix"></div>\n<div class="file-caption {class}">\n  <span class="file-caption-icon"></span>\n  <div class="input-group">\n{caption}\n' + (t.isBs(5) ? "" : '<div class="input-group-btn input-group-append">\n') + "      {remove}\n      {cancel}\n      {pause}\n      {upload}\n      {browse}\n" + (t.isBs(5) ? "" : "    </div>\n") + "  </div>", a = '{preview}\n<div class="kv-upload-progress kv-hidden"></div>\n<div class="clearfix"></div>\n<span class="{class}">{remove}\n{cancel}\n{upload}\n{browse}\n</span>', r = '<div class="file-preview {class}">\n  {close}  <div class="{dropClass} clearfix">\n    <div class="file-preview-thumbnails clearfix">\n    </div>\n    <div class="file-preview-status text-center text-success"></div>\n    <div class="kv-fileinput-error"></div>\n  </div>\n</div>', o = t.closeButton("fileinput-remove"), n = '<i class="icon-line-file"></i>', s = '<input readonly class="file-caption-name form-control {class}">\n', l = '<button type="{type}" title="{title}" class="{css}" {status} {tabIndexConfig}>{icon} {label}</button>', d = '<a href="{href}" title="{title}" class="{css}" {status} {tabIndexConfig}>{icon} {label}</a>', c = '<div class="{css}" {status} {tabIndexConfig}>{icon} {label}</div>', Z = t.MODAL_ID + "Label", u = '<div id="' + t.MODAL_ID + '" class="file-zoom-dialog modal fade" aria-labelledby="' + Z + '" {tabIndexConfig}></div>',
        p = '<div class="modal-dialog modal-lg{rtl}" role="document">\n  <div class="modal-content">\n    <div class="modal-header">\n      <h5 class="modal-title" id="' + Z + '">{heading}</h5>\n      <span class="kv-zoom-title"></span>\n      <div class="kv-zoom-actions">{toggleheader}{fullscreen}{borderless}{close}</div>\n    </div>\n    <div class="modal-body">\n      <div class="floating-buttons"></div>\n      <div class="kv-zoom-body file-zoom-content {zoomFrameClass}"></div>\n{prev} {next}\n    </div>\n  </div>\n</div>\n', f = '<div class="progress">\n    <div class="{class}" role="progressbar" aria-valuenow="{percent}" aria-valuemin="0" aria-valuemax="100" style="width:{percent}%;">\n        {status}\n     </div>\n</div>{stats}', N = '<div class="text-primary file-upload-stats"><span class="pending-time">{pendingTime}</span> <span class="upload-speed">{uploadSpeed}</span></div>', g = " <samp>({sizeText})</samp>", m = '<div class="file-thumbnail-footer">\n    <div class="file-footer-caption" title="{caption}">\n        <div class="file-caption-info">{caption}</div>\n        <div class="file-size-info">{size}</div>\n    </div>\n    {progress}\n{indicator}\n{actions}\n</div>', v = '<div class="file-actions">\n    <div class="file-footer-buttons">\n        {download} {upload} {delete} {zoom} {other}    </div>\n</div>\n{drag}\n<div class="clearfix"></div>', h = '<button type="button" class="kv-file-remove {removeClass}" title="{removeTitle}" {dataUrl}{dataKey}>{removeIcon}</button>\n', w = '<button type="button" class="kv-file-upload {uploadClass}" title="{uploadTitle}">{uploadIcon}</button>', b = '<a class="kv-file-download {downloadClass}" title="{downloadTitle}" href="{downloadUrl}" download="{caption}" target="_blank">{downloadIcon}</a>', _ = '<button type="button" class="kv-file-zoom {zoomClass}" title="{zoomTitle}">{zoomIcon}</button>', C = '<span class="file-drag-handle {dragClass}" title="{dragTitle}">{dragIcon}</span>', x = '<div class="file-upload-indicator" title="{indicatorTitle}">{indicator}</div>', y = '<div class="file-preview-frame {frameClass}" id="{previewId}" data-fileindex="{fileindex}" data-fileid="{fileid}" data-template="{template}"', T = y + '><div class="kv-file-content">\n', P = y + ' title="{caption}"><div class="kv-file-content">\n', F = "</div>{footer}\n{zoomCache}</div>\n", k = "{content}\n", O = " {style}", S = W("html", "text/html"), I = W("text", "text/plain;charset=UTF-8"), M = W("pdf", "application/pdf"), E = '<img src="{data}" class="file-preview-image kv-preview-data" title="{title}" alt="{alt}"' + O + ">\n", A = '<iframe class="kv-preview-data file-preview-office" src="https://view.officeapps.live.com/op/embed.aspx?src={data}"' + O + "></iframe>", D = '<iframe class="kv-preview-data file-preview-gdocs" src="https://docs.google.com/gview?url={data}&embedded=true"' + O + "></iframe>", z = '<video class="kv-preview-data file-preview-video" controls' + O + '>\n<source src="{data}" type="{type}">\n' + t.DEFAULT_PREVIEW + "\n</video>\n", $ = '<!--suppress ALL --><audio class="kv-preview-data file-preview-audio" controls' + O + '>\n<source src="{data}" type="{type}">\n' + t.DEFAULT_PREVIEW + "\n</audio>\n", j = '<embed class="kv-preview-data file-preview-flash" src="{data}" type="application/x-shockwave-flash"' + O + ">\n", U = '<object class="kv-preview-data file-preview-object file-object {typeCss}" data="{data}" type="{type}"' + O + '>\n<param name="movie" value="{caption}" />\n' + t.OBJECT_PARAMS + " " + t.DEFAULT_PREVIEW + "\n</object>\n", R = '<div class="kv-preview-data file-preview-other-frame"' + O + ">\n" + t.DEFAULT_PREVIEW + "\n</div>\n", B = '<div class="kv-zoom-cache">{zoomContent}</div>', L = {
          ...
          height: "100%",
          "min-height": "480px"
        }, H._isPdfRendered() && (M = H.pdfRendererTemplate.replace("{renderer}", H._encodeURI(H.pdfRendererUrl))), H.defaults = {
          layoutTemplates: {
            main1: i,
            main2: a,
            preview: r,
          ...
          fileActionSettings: {
            ...
            showZoom: !0,
            showDrag: !0,
            removeIcon: '<i class="icon-line-trash"></i>',
            removeClass: q,
            removeErrorClass: "btn btn-sm btn-kv btn-danger",
            removeTitle: "Remove file",
            uploadIcon: '<i class=icon-line-upload"></i>',
            uploadClass: q,
            uploadTitle: "Upload file",
            uploadRetryIcon: '<i class="icon-line-rotate-cw"></i>',
            uploadRetryTitle: "Retry upload",
            downloadIcon: '<i class="icon-line-download"></i>',
            downloadClass: q,
            downloadTitle: "Download file",
            zoomIcon: '<i class="icon-line-zoom-in"></i>',
            zoomClass: q,
            zoomTitle: "View Details",
            dragIcon: '<i class="icon-line-move"></i>',
            dragClass: "text-primary",
            dragTitle: "Move / Rearrange",
            dragSettings: {},
            indicatorNew: '<i class="icon-line-plus text-warning"></i>',
            indicatorSuccess: '<i class="icon-line-check text-success"></i>',
            indicatorError: '<i class="icon-exclamation-sign text-danger"></i>',
            indicatorLoading: '<i class="icon-hourglass-end text-muted"></i>',
            indicatorPaused: '<i class="icon-pause1 text-primary"></i>',
    ...
    _initPreviewCache: function() {
      ...
      i.previewCache = {
        ...
        get: function(e, a) {
          ...
          return g && g.length ? (a = void 0 === a ? !0 : a, o = t.ifSet("type", f, i.initialPreviewFileType || "generic"), l = t.ifSet("filename", f, t.ifSet("caption", f)), d = t.ifSet("filetype", f, o), s = i.previewCache.footer(e, a, f && f.size || null), c = t.ifSet("frameClass", f), r = m ? h(o, g, l, d, s, u, c) : h("generic", g, l, d, s, u, c, o).setTokens({
            content: p.content[e]
    ...
    _initZoomButtons: function() {
      ...
      return n.length < 2 ? (s.hide(), void l.hide()) : (s.show(), l.show(), void(o && (t = e(n[0]), i = e(n[o - 1]), s.removeAttr("disabled"), l.removeAttr("disabled"), t.length && t.attr("id") === r && s.attr("disabled", !0), i.length && i.attr("id") === r && l.attr("disabled", !0))))
    },
    ...
    _setZoomContent: function(i, a) {
      var r, n, o, s, l, d, c, u, p, f, g = this,
        m = i.attr("id"),
        v = g._getZoom(m),
        h = g.$modal,
      ...
      n = v.attr("data-template") || "generic", r = v.find(".kv-file-content"), o = r.length ? r.html() : "", p = i.data("caption") || "", f = i.data("size") || "", s = p + " " + f, h.find(".kv-zoom-title").attr("title", e("<div/>").html(s).text()).html(s), l = h.find(".kv-zoom-body"), h.removeClass("kv-single-content"), a ? (u = l.addClass("file-thumb-loading").clone().insertAfter(l), t.setHtml(l, o).hide(), u.fadeOut("fast", function() {
        ...
        var i = t.which || t.keyCode,
          ...
          o = g.rtl ? 39 : 37,
          s = g.rtl ? 37 : 39;
        i === o && a.length && !a.attr("disabled") && g._zoomSlideShow("prev", n), i === s && r.length && !r.attr("disabled") && g._zoomSlideShow("next", n)
      })
    },
      ...
      if (!l.attr("disabled")) {
        ...
        for (u = c.length, r = 0; u > r; r++)
          if (e(c[r]).attr("id") === i) {
            o = "prev" === t ? r - 1 : r + 1;
            break
          } 0 > o || o >= u || !c[o] || (a = e(c[o]), a.length && s._setZoomContent(a, !0), s._initZoomButtons(), s._raise("filezoom" + t, {
          previewId: i,
          modal: s.$modal
        }))
      }
    ...
    _initUploadSuccess: function(i, a, r) {
      var n, o, s, l, d, c, u, p, f, g, m = this;
      return !m.showPreview || "object" != typeof i || e.isEmptyObject(i) ? void m._resetCaption() : (void 0 !== i.initialPreview && i.initialPreview.length > 0 && (m.hasInitData = !0, c = i.initialPreview || [], u = i.initialPreviewConfig || [], p = i.initialPreviewThumbTags || [], n = void 0 === i.append || i.append, c.length > 0 && !t.isArray(c) && (c = c.split(m.initialPreviewDelimiter)), c.length && (m._mergeArray("initialPreview", c), m._mergeArray("initialPreviewConfig", u), m._mergeArray("initialPreviewThumbTags", p)), void 0 !== a ? r ? (f = a.attr("id"), g = m._getUploadCacheIndex(f), null !== g && (m.uploadCache[g] = {
        ...
        tags: p[0] || [],
        append: n
      })) : (s = m.previewCache.add(c[0], u[0], p[0], n), o = m.previewCache.get(s, !1), l = t.createElement(o).hide().appendTo(a), d = l.find(".kv-zoom-cache"), d && d.length && d.appendTo(a), a.fadeOut("slow", function() {
    ...
    _uploadSingle: function(i, a, r) {
      var n, o, s, l, d, c, u, p, f, g, m, v, h, w = this,
        b = w.fileManager,
        _ = b.count(),
        C = new FormData,
        x = w._getThumbId(a),
      ...
      w.enableResumableUpload || (w.showPreview && (o = b.getThumb(a), u = o.find(".file-thumb-progress"), l = o.find(".kv-file-upload"), d = o.find(".kv-file-remove"), u.show()), 0 === _ || !y || w.showPreview && l && l.hasClass("disabled") || w._abort(F) || (h = function() {
        ...
        n = w._getOutData(C, p, s), e.extend(!0, F, n), setTimeout(function() {
          t.isEmpty(s) || t.isEmpty(s.error) ? (w.showPreview && (w._setThumbStatus(o, "Success"), l.hide(), w._initUploadSuccess(s, o, r), w._setProgress(101, u)), w._raise("fileuploaded", [n, g, i, w._getThumbFileId(o)]), r ? h() : w.fileManager.remove(o)) : (c = !0, f = w._parseError(T, p, w.msgUploadError, w.fileManager.getFileName(a)), w._showFileError(f, F), w._setPreviewError(o, !0), w.retryErrorUploads || l.hide(), r && h(), w._setProgress(101, w._getFrame(g).find(".file-thumb-progress"), w.msgUploadError))
        }, w.processDelay)
      }, m = function() {
        ...
        f = w._parseError(T, t, n, w.fileManager.getFileName(a)), c = !0, setTimeout(function() {
          var i;
          r && h(), w.fileManager.setProgress(a, 100), w._setPreviewError(o, !0), w.retryErrorUploads || l.hide(), e.extend(!0, F, w._getOutData(C, t)), w._setProgress(101, w.$progress, w.msgAjaxProgressError.replace("{operation}", T)), i = w.showPreview && o ? o.find(".file-thumb-progress") : "", w._setProgress(101, i, w.msgUploadError), w._showFileError(f, F)
        }, w.processDelay)
    ...
    _uploadBatch: function() {
      ...
      if (0 !== c && p && !l._abort(u)) {
        ...
        e.each(l.fileManager.stack, function(e, i) {
          t.isEmpty(i.file) || l._setFileData(f, i.file, i.nameFmt || "untitled_" + m, e), m++
    ...
    _uploadExtraOnly: function() {
      ...
      o._abort(s) || (e = function(e) {
        o.lock();
        var t = o._getOutData(l, e);
        o._raise("filebatchpreupload", [t]), o._setProgress(50), s.data = t, s.xhr = e, o._abort(s) && (e.abort(), o._setProgressCancelled())
      }, i = function(e, i, a) {
    ...
    _resetCaption: function() {
      ...
      setTimeout(function() {
        ...
        0 !== n || 0 !== r || s ? (i = r + n, i > 1 ? t = e._getMsgSelected(i) : (a = e.fileManager.getFirstFile(), t = a ? a.nameFmt : "_"), e._setCaption(t)) : e.reset()
      }, e.processDelay)
    },
      ...
      i._initZoomButton(), a.find(n).each(function() {
        ...
        if (!t.isEmpty(p) && void 0 !== f) {
          ...
          x = parseInt(x.replace(t.INIT_FLAG, "")), h = t.isEmpty(C.config) && t.isEmpty(C.config[x]) ? null : C.config[x], b = t.isEmpty(h) || t.isEmpty(h.extra) ? r : h.extra, w = h && (h.filename || h.caption) || "", "function" == typeof b && (b = b()), v = {
            ...
            })) : (v.jqXHR = n, v.response = e, a = i._parseError(g, n, i.msgDeleteError, w), i._showFileError(a, v, "filedeleteerror"), _.removeClass("file-uploading"), u.removeClass("disabled " + s).addClass(l), void d())
          }, c = function(e, t, a) {
    ...
    _getSize: function(t, i) {
      var a, r, n = this,
        o = parseFloat(t),
        s = n.fileSizeGetter;
      return e.isNumeric(t) && e.isNumeric(o) ? ("function" == typeof s ? r = s(o) : 0 === o ? r = "0.00 B" : (i || (i = ["B", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"]), a = Math.floor(Math.log(o) / Math.log(1024)), r = (o / Math.pow(1024, a)).toFixed(2) + " " + i[a]), n._getLayoutTemplate("size").replace("{sizeText}", r)) : ""
    },
    _getFileType: function(e) {
      var t = this;
      return t.mimeTypeAliases[e] || e
    },
    _generatePreviewTemplate: function(i, a, r, n, o, s, l, d, c, u, p, f, g, m) {
      var v, h, w, b = this,
        _ = b.slug(r),
        C = "",
        x = "",
      ...
      return h = 400 > y ? b.previewSettingsSmall[I] || b.defaults.previewSettingsSmall[I] : b.previewSettings[I] || b.defaults.previewSettings[I], h && e.each(h, function(e, t) {
        ...
        var m = d ? "zoom-" + o : o,
          ...
          h = (c || "") + " " + u;
        return b.frameClass && (h = b.frameClass + " " + h), d && (h = h.replace(" " + t.SORT_CSS, "")), v = b._parseFilePreviewIcon(v, r), "object" !== i || n || e.each(b.defaults.fileTypeSettings, function(e, t) {
      ...
      }, p = p || o.slice(o.lastIndexOf("-") + 1), b.fileActionSettings.showZoom && (C = w(E ? "other" : i, m ? m : a, !0, "kv-zoom-thumb")), C = "\n" + b._getLayoutTemplate("zoomCache").replace("{zoomContent}", C), "function" == typeof b.sanitizeZoomCache && (C = b.sanitizeZoomCache(C)), v = w(S ? "other" : i, a, !1, "kv-preview-thumb"), v.setTokens({
        zoomCache: C
      })
    },
    ...
    _previewFile: function(e, i, a, r, n) {
      if (this.showPreview) {
        var o, s = this,
          ...
          v = m.getId(i),
          h = s._getThumbId(v);
        o = s._generatePreviewTemplate(u, g, l, d, h, v, !1, f), s._clearDefaultPreview(), s._addToPreview(p, o);
        var w = s._getFrame(h);
        s._validateImageOrientation(w.find("img"), i, h, v, c, d, f, g), s._setThumbAttr(h, c, f), s._initSortable()
      }
    },
    ...
    _setInitThumbAttr: function() {
      ...
      if (0 !== s)
        for (var l = 0; s > l; l++) e = o.config[l], r = n.previewInitId + "-" + t.INIT_FLAG + l, i = t.ifSet("caption", e, t.ifSet("filename", e)), a = t.ifSet("size", e), n._setThumbAttr(r, i, a)
    },
    ...
    _updateFileDetails: function(e, i) {
      ...
      !c && l.fileManager.count() > 0 ? (s = l.fileManager.getFirstFile(), a = s.nameFmt) : a = c ? l.slug(c) : "_", r = l.isAjaxUpload ? l.fileManager.count() : e, o = l.previewCache.count(!0) + r, n = 1 === r ? a : l._getMsgSelected(o, !l.isAjaxUpload && !l.isError), l.isError ? (l.$previewContainer.removeClass("file-thumb-loading"), l._initCapStatus(), l.$previewStatus.html(""), l.$captionContainer.removeClass("icon-visible")) : l._showFileIcon(), l._setCaption(n, l.isError), l.$container.removeClass("file-input-new file-input-ajax-new"), i || l._raise("fileselect", [e, a]), l.previewCache.count(!0) && l._initPreviewActions()
    },
      ...
      if (n.showPreview || o && o.length) {
        ...
        if (n.enableResumableUpload) {
          var g, m = r.loaded,
            v = d.getUploadedSize(),
            h = d.file.size;
          m += v, g = l.uploadedSize + m, a = t.round(100 * m / h), r.pendingBytes = h - v, n._setResumableProgress(a, r, c), s = Math.floor(100 * g / p), f.pendingBytes = p - g, n._setResumableProgress(s, f)
    ...
    _checkDimensions: function(e, i, a, r, n, o, s) {
      var l, d, c, u, p = this,
        f = "Small" === i ? "min" : "max",
        g = p[f + "Image" + o];
      !t.isEmpty(g) && a.length && (c = a[0], d = "Width" === o ? c.naturalWidth || c.width : c.naturalHeight || c.height, u = "Small" === i ? d >= g : g >= d, u || (l = p["msgImage" + o + i].setTokens({
        name: n,
        size: g
    ...
    setImageOrientation: function(i, a, r, n) {
      ...
      c && u || (l = "load.fileinputimageorient", f ? (i = a, a = null, i.css(d.previewSettings.image), s = e(document.createElement("div")).appendTo(n.find(".kv-file-content")), o = e(document.createElement("span")).insertBefore(i), i.css("visibility", "hidden").removeClass("file-zoom-detail").appendTo(s)) : p = !i.is(":visible"), i.off(l).on(l, function() {
        ...
        var m = Math.atan(u / c),
          ...
          w = " scale(" + Math.abs(h) + ")";
        t.setTransform(e, g + w), t.setTransform(l, g + w), f && (i.css("visibility", "visible").insertAfter(o).addClass("file-zoom-detail"), o.remove(), s.remove())
      }))
    },
    _validateImageOrientation: function(i, a, r, n, o, s, l, d) {
      var c, u, p = this,
        f = null,
        g = p.autoOrientImage;
      return p.canOrientImage ? (i.css("image-orientation", g ? "from-image" : "none"), void p._validateImage(r, n, o, s, l, d, f)) : (u = t.getZoomSelector(r, " img"), f = g ? p._getExifObj(d) : null, (c = f ? f["0th"][piexif.ImageIFD.Orientation] : null) ? (p.setImageOrientation(i, e(u), c, p._getFrame(r)), p._raise("fileimageoriented", {
        $img: i,
        file: a
    ...
    _validateImage: function(e, t, i, a, r, n, o) {
      ...
      i = i || "Untitled", g.one("load", function() {
        l = p.width(), d = u.width(), l > d && g.css("width", "100%"), s = {
          ind: f,
          id: e,
          fileId: t
        }, c._checkDimensions(f, "Small", g, p, i, "Width", s), c._checkDimensions(f, "Small", g, p, i, "Height", s), c.resizeImage || (c._checkDimensions(f, "Large", g, p, i, "Width", s), c._checkDimensions(f, "Large", g, p, i, "Height", s)), c._raise("fileimageloaded", [e]), c.fileManager.addImage(t, {
          ind: f,
          img: g,
          thumb: p,
          pid: e,
    ...
    _getResizedImage: function(i, a, r, n) {
      var o, s, l, d, c, u, p, f, g, m, v = this,
        h = e(a.img)[0],
        w = h.naturalWidth,
        b = h.naturalHeight,
        _ = 1,
      ...
      if (c = function(e, t, i) {
          ...
          index: S,
          fileId: i
        }, m = [i, k, S], (!f || !y || C >= w && x >= b) && (y && f && v._raise("fileimageresized", m), r.val++, r.val === n && v._raise("fileimagesresized"), !y)) return void c(v.msgImageResizeError, g, "fileimageresizeerror");
      F = F || v.resizeDefaultImageType, s = w > C, l = b > x, _ = "width" === v.resizePreference ? s ? C / w : l ? x / b : 1 : l ? x / b : s ? C / w : 1, v._resetCanvas(), w *= _, b *= _, T.width = w, T.height = b;
      try {
        P.drawImage(h, 0, 0, w, b), d = T.toDataURL(F, v.resizeQuality), I && (p = window.piexif.dump(I), d = window.piexif.insert(p, d)), o = t.dataURI2Blob(d), v.fileManager.setFile(i, o), v._raise("fileimageresized", m), r.val++, r.val === n && v._raise("fileimagesresized", [void 0, void 0]), o instanceof Blob || c(v.msgImageResizeError, g, "fileimageresizeerror")
      } catch (A) {
    ...
    _setCaption: function(i, a) {
      ...
      if (c.$caption.length) {
        if (c.$captionContainer.removeClass("icon-visible"), a) r = e("<div>" + c.msgValidationError + "</div>").text(),
          s = c.fileManager.count(), s ? (d = c.fileManager.getFirstFile(), l = 1 === s && d ? d.nameFmt : c._getMsgSelected(s)) : l = c._getMsgSelected(c.msgNo), n = t.isEmpty(i) ? l : i, o = '<span class="' + c.msgValidationErrorClass + '">' + c.msgValidationErrorIcon + "</span>";
        else {
    ...
    _renderFileFooter: function(e, i, a, r, n) {
      ...
      return a = l._getSize(a), s = {
        ...
        progress: "",
        indicator: w
      }, l.isAjaxUpload ? (s.progress = l._renderThumbProgress(), s.actions = l._renderFileActions(s, p, !1, c, f, u, !1, !1, !1)) : s.actions = l._renderFileActions(s, !1, !1, !1, f, u, !1, !1, !1), o = g.setTokens(s), o = t.replaceTags(o, l.previewThumbTags)
    },
    ...
    _change: function(i) {
      ...
      if (e(document.body).off("focusin.fileinput focusout.fileinput"), !a.changeTriggered) {
        ...
        if (a._resetErrors(), s = r.length, o = c ? a.fileManager.count() + s : s, n = a._getFileCount(o, v ? !1 : void 0), g > 0 && n > g) {
    ...
    _canPreview: function(e) {
      ...
      return a = !u || -1 !== u.indexOf(c), r = !p || -1 !== p.indexOf(l), n = !f.length || t.compare(s, w), o = g && -1 !== g.indexOf(c) || m && -1 !== m.indexOf(l) || v.length && t.compare(s, b) || h && !isNaN(h) && d > h, !o && (a || r || n)
    },
    ...
    readFiles: function(i) {
      ...
      r.fileManager.clearImages(), e.each(i, function(e, t) {
        ...
        r.lock(!0);
        var x, y, T, P, F, k, S, E, I, A, D, z, $ = i[w],
          j = r._getFileId($),
          U = c + "-" + j,
          M = p.image,
          R = r._getFileName($, ""),
          ...
          q = function() {
            ...
            }, r.processDelay), r._raise("fileloaded", [$, U, j, w, n]) && r.isAjaxUpload ? e || C.add($) : e && C.removeFile(j)
          };
        if ($) {
          if (E = C.getId($), g > 0)
            for (y = 0; g > y; y++) k = f[y], S = r.msgFileTypes[k] || k, Z += 0 === y ? S : ", " + S;
          if (R === !1) return void a(w + 1);
          if (0 === R.length) return T = r.msgInvalidFileName.replace("{name}", t.htmlEncode(t.getFileName($), "[unknown]")), void h(T, $, U, w, E);
          if (t.isEmpty(m) || (B = new RegExp("\\.(" + m.join("|") + ")$", "i")), x = O.toFixed(2), r.isAjaxUpload && C.exists(E) || r._getFrame(U, !0).length) {
            var V = {
              id: U,
              index: w,
              fileId: E,
            ...
            return T = r.msgDuplicateFile.setTokens({
              name: R,
              size: x
            }), void(r.isAjaxUpload ? (r.duplicateErrors.push(T), r.isDuplicateError = !0, r._raise("fileduplicateerror", [$, E, R, x, U, w]), a(w + 1), r._updateFileDetails(u)) : (r._showError(T, V), r.unlock(), u = 0, r._clearFileInput(), r.reset(), r._updateFileDetails(u)))
          }
          ...
          if (!r._canPreview($)) return I = r.isAjaxUpload && r._raise("filebeforeload", [$, w, n]), r.isAjaxUpload && I && C.add($), r.showPreview && I && (o.addClass("file-thumb-loading"), r._initCapStatus("processing"), r._previewDefault($), r._initFileActions()), void setTimeout(function() {
            I && r._updateFileDetails(u), a(w + 1), r._raise("fileloaded", [$, U, j, w])
          }, 10);
          D = M($.type, R), s.html(l.replace("{index}", w + 1).replace("{files}", u)), o.addClass("file-thumb-loading"), r._initCapStatus("processing"), n.onerror = function(e) {
            r._errorHandler(e, R)
          }, n.onload = function(i) {
            var a, l, d, c, u, f, g = [],
              m = function() {
                ...
                e.onerror = function(e) {
                  ...
                  return r.isAjaxUpload && !r._raise("filebeforeload", [$, w, n]) ? (H = !0, r._resetCaption(), n.abort(), s.html(""), o.removeClass("file-thumb-loading"), r._initCapStatus("valid"), void r.enable()) : (r._previewFile(w, $, e, L, l), r._initFileActions(), void q())
                }, e.readAsDataURL($)
              };
            if (l = {
                name: R,
              ...
              for (d = new Uint8Array(i.target.result), y = 0; y < d.length; y++) c = d[y].toString(16), g.push(c);
              if (a = g.join("").toLowerCase().substring(0, 8), f = t.getMimeType(a, "", ""), t.isEmpty(f) && (u = t.arrayBuffer2String(n.result), f = t.isSvg(u) ? "image/svg+xml" : t.getMimeType(a, u, $.type)), l = {
                  name: R,
                  type: f
                }, D = M(f, "")) return void m(z)
            }
            return r.isAjaxUpload && !r._raise("filebeforeload", [$, w, n]) ? (H = !0, r._resetCaption(), n.abort(), s.html(""), o.removeClass("file-thumb-loading"), r._initCapStatus("valid"), void r.enable()) : (r._previewFile(w, $, i, L, l), r._initFileActions(), void q())
    ...
    upload: function() {
      ...
      return n.bpsLog = [], n.bps = 0, r.isAjaxUpload && !r.isDisabled && r._isFileSelectionValid(o) ? (r.lastProgress = 0, r._resetUpload(), 0 !== o || s ? (r.cancelling = !1, r._showProgress(), r.lock(), 0 === o && s ? (r._setProgress(2), void r._uploadExtraOnly()) : r.enableResumableUpload ? r.resume() : ((r.uploadAsync || r.enableResumableUpload) && (a = r._getOutData(null), r._raise("filebatchpreupload", [a]), r.fileBatchCompleted = !1, r.uploadCache = [], e.each(r.getFileStack(), function(e) {
  ...
  e.fn.fileinput.defaults = {
    ...
    previewZoomButtonIcons: {
      ...
      toggleheader: '<i class="icon-line-expand"></i>',
      fullscreen: '<i class="icon-resize-full"></i>',
      borderless: '<i class="icon-line-external-link"></i>',
      close: '<i class="icon-line-cross"></i>'
    },
    ...
    customLayoutTags: {},
    customPreviewTags: {},
    previewFileIcon: '<i class="icon-line-file"></i>',
    previewFileIconClass: "file-other-icon",
    previewFileIconSettings: {},
    previewFileExtSettings: {},
    buttonLabelClass: "hidden-xs",
    browseIcon: '<i class="icon-line-folder"></i> ',
    browseClass: "btn btn-secondary",
    removeIcon: '<i class="icon-line-trash"></i>',
    removeClass: "btn btn-danger",
    cancelIcon: '<i class="icon-line-ban"></i>',
    cancelClass: n,
    pauseIcon: '<i class="icon-pause1"></i>',
    pauseClass: n,
    uploadIcon: '<i class="icon-line-upload"></i>',
    uploadClass: n,
    uploadUrl: null,
    ...
    dropZoneTitle: "Drag & drop file di sini &hellip;",
